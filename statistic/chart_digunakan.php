...
<script type="text/javascript">	
	$('#Chart1').insertFusionCharts({
		swfPath: "charts/",
		type: "Pie2D",
		data:	"<graph caption='Ticket Received By Entity' subcaption='This Year' decimalPrecision='0'" +
				...
				"<set value='<?php echo $arr_value[1];?>' name='<?php echo $arr_name[1];?>' color='00FFFF' /> </graph>",
		dataFormat: "XMLData",
		width: "520",
		height: "300"
	});

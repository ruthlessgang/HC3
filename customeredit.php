...
{	$namacustomer 	= $_POST['namacustomer'];
	...
	$customers->update_customer($id_cust,$namacustomer,$lokasi,$Telp,$email,$pic,$selesperson,$customerproduct);
...
<head>
	...
	{	if (customerform.idcustomer.value == "")
		...
		if (customerform.lokasi.value == "")
		{	alert("Customer address must be filled!");
			customerform.lokasi.focus();
			return false;
		}
...
<body>	
	...
	<table class="formtable">
		...
		<tr align="left">
			<td> Address </td><td> : </td>
			<td> <textarea name="lokasi" rows="3" cols="38"><?php echo $member['lokasi']; ?></textarea> </td>
		</tr>
		<tr align="left">
			<td> Telp </td><td> : </td>

...
{	if ($users->user_exists($_POST['username']) == true && !empty($_POST['username']))
	...
	{	$fullname 	= $_POST['fullname'];
		...
		$level 		= $_POST['level'];
		$locked 	= $_POST['locked'];
		$users->register($username,$password,$email,$email2,$email3,$fullname,$Telp,$level,$locked);
...
<body>	
	...
	<label>Email 2 :</label> <input type='text' size='30' name='email2'/> <br/>
	<label>Email 3 :</label> <input type='text' size='30' name='email3'/> <br/>

...
{	$fullname 	= $_POST['fullname'];
	...
	$users->update($id,$username,$password,$email,$email2,$email3,$fullname,$Telp,$level,$locked);
...
<body>	
	...
	<label>Email 2 :</label> <input type='text' size='30' name='email2' value='<?php echo $member['email2']; ?>'> </td>	
	<label>Email 3 :</label> <input type='text' size='30' name='email3' value='<?php echo $member['email3']; ?>'> </td>	
	...
	<label>User Level :</label> 
		<select name="level">
			...
			<option value="Helpdesk Admin"> Helpdesk Admin </option>

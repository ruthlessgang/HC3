...
<?php
	...
	{	echo '
			<div id="leftmenu">
				<div id="headleftmenu">Download Report</div>
				<ul>
				  <li><a href="statistic/summaryreport.php" target="contentFrame">Download All Tickets</a></li>
	...
	else if ($user['level'] == "Helpdesk Admin")
	{	echo '
			<div id="leftmenu">
				<div id="headleftmenu">Download Report</div>
				<ul>
			...
			<div id="leftmenu">
				<div id="headleftmenu">Monitoring Ticket</div>
					<ul>
					<li><a href="allticketwaitforclosed.php" target="contentFrame">All Ticket</a></li>
					</ul>
			 </div>'; 
	}
?>
